...
//     const p5ToStart = TweenMax.to(this.part5Trigger, 1, {
//       y: 0,
//       ease: Linear.easeNone,
//     })
...
//     const p4ToStart = TweenMax.to(this.part4Trigger, 1, {
//       y: 0,
//       ease: Linear.easeNone,
//     })
...
//               </p>
//               <ol className="parts">
//                 <li className="part1" ref={li => (this.part1Trigger = li)}>
//                   <h2>Heading 1</h2>
//                   <p>
...
//                   </p>
//                 </li>
//                 <li className="part2" ref={li => (this.part2Trigger = li)}>
//                   <h2>Heading 2</h2>
//                   <p>
//                     Vivamus hendrerit in dui arcu sed erat molestie vehicula.
//                     Nullam in dui mauris.
//                   </p>
//                 </li>
//                 <li className="part3" ref={li => (this.part3Trigger = li)}>
//                   <h2>Heading 3</h2>
//                   <p>
//                     Vivamus hendrerit in dui arcu sed erat molestie vehicula.
//                     Nullam in dui mauris.
//                   </p>
//                 </li>
//                 <li className="part4" ref={li => (this.part4Trigger = li)}>
//                   <h2>Heading 4</h2>
//                   <p>
//                     Vivamus hendrerit in dui arcu sed erat molestie vehicula.
//                     Nullam in dui mauris.
//                   </p>
//                 </li>
//                 <li className="part5" ref={li => (this.part5Trigger = li)}>
//                   <h2>Heading 5</h2>
//                   <p>
//                     Vivamus hendrerit in dui arcu sed erat molestie vehicula.
//                     Nullam in dui mauris.
//                   </p>
//                 </li>
//                 <li className="part6" ref={li => (this.part6Trigger = li)}>
//                   <h2>Heading 6</h2>
//                   <p>
//                     Vivamus hendrerit in dui arcu sed erat molestie vehicula.
//                     Nullam in dui mauris.
